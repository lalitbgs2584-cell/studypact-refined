      ...
      <div className="grid gap-4 lg:grid-cols-[1.12fr_0.88fr]">
        ...
        <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
          ...
          <TrackerScoreRing
            ...
            label="Best streak"
            helper={`${overview.summary.bestStreak} best day${overview.summary.bestStreak === 1 ? "" : "s"} in a row`}
          />
        </div>
      </div>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <Select
                    id="understanding"
                    name="understanding"
                    defaultValue={overview.reflection?.understanding ?? ReflectionUnderstanding.PARTIALLY_UNDERSTOOD}
                  >
                    <option value={ReflectionUnderstanding.UNDERSTOOD}>Understood</option>
                    <option value={ReflectionUnderstanding.PARTIALLY_UNDERSTOOD}>Partially Understood</option>
                    <option value={ReflectionUnderstanding.NOT_UNDERSTOOD}>Not Understood</option>
                  </Select>
                </div>
                <div className="space-y-2">
