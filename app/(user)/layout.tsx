  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-background text-foreground">
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(to right, rgba(42,42,64,0.55) 1px, transparent 1px), linear-gradient(to bottom, rgba(42,42,64,0.55) 1px, transparent 1px)",
      ...
      <div className="pointer-events-none absolute right-0 top-1/3 z-0 h-[28rem] w-[28rem] rounded-full bg-accent/5 blur-[120px]" />
