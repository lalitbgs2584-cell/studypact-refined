      ...
      <div className="relative z-10 w-full max-w-md p-8">
        <div className="relative overflow-hidden rounded-3xl border border-border bg-card/90 p-10 shadow-2xl backdrop-blur-2xl">
          ...
          <div className="mb-10 text-center">
            ...
            <h1 className="mb-2 text-3xl font-black tracking-tight text-foreground">Join StudyPact</h1>
            <p className="text-sm font-medium text-muted-foreground">Create your account to master your goals.</p>
          </div>
