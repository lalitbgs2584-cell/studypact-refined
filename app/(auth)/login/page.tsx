      ...
      <div className="mx-auto w-full max-w-md px-4" style={{ position: "relative", zIndex: 1 }}>
        <div style={{
          ...
          <div style={{ textAlign: "center", marginBottom: 32 }}>
            ...
            <p style={{ fontSize: 13, color: "#A09880", margin: 0 }}>Access your pacts and prove your execution.</p>
          </div>

          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            <div>
              <label style={{ display: "block", fontSize: 10, fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.12em", color: "#6A7888", marginBottom: 6 }}>
                Email Address
              </label>
              <input
            ...
            <div>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 6 }}>
                <label style={{ fontSize: 10, fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.12em", color: "#6A7888" }}>
                  Password
                </label>
                <a href="#" style={{ fontSize: 11, color: "#C4AC78" }}>Forgot?</a>
              </div>
              <div style={{ position: "relative" }}>
                <input
                  ...
                  style={{
                    width: "100%", background: "rgba(196,172,120,0.05)", backdropFilter: "blur(8px)",
                    border: "1px solid rgba(196,172,120,0.14)", borderRadius: 10,
                    padding: "11px 42px 11px 14px", fontSize: 14, color: "#EDE6D6",
                    outline: "none", transition: "border-color 0.2s ease",
                    boxSizing: "border-box",
                  }}
                />
          ...
          <p style={{ marginTop: 24, textAlign: "center", fontSize: 12, color: "#6A7888" }}>
            ...
            <Link href="/signup" style={{ color: "#C4AC78" }}>Commit Here</Link>
          </p>
        </div>
      </div>
    </div>
