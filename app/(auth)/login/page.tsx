      ...
      <div className="w-full max-w-md p-8 relative z-10">
        <div className="rounded-3xl border border-white/10 bg-white/[0.02] p-10 backdrop-blur-2xl shadow-2xl relative overflow-hidden">
          ...
          <div className="mb-10 text-center">
            ...
            <p className="text-white/40 text-sm font-medium">Access your pacts and prove your execution.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Link href="#" className="text-xs text-[#f97316] hover:underline">Forgot?</Link>
              </div>
              <input 
                type="password" 
                required 
          ...
          <p className="mt-8 text-center text-xs font-medium text-white/40">
            Don't have an account? <Link href="/signup" className="text-[#f97316] hover:underline">Commit Here</Link>
          </p>
        </div>
      </div>
    </div>
