...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-background selection:bg-primary/30 selection:text-primary-foreground">
      <div
      ...
      <div className="relative z-10 w-full max-w-md p-8">
        <div className="relative overflow-hidden rounded-lg border border-border bg-card p-10 shadow-[0_0_40px_-24px_rgba(0,255,178,0.3)] backdrop-blur-xl">
          ...
          <div className="mb-10 text-center">
            ...
            <h1 className="mb-2 text-3xl font-black tracking-tight text-foreground">Welcome Back</h1>
            <p className="text-sm font-medium text-muted-foreground">Access your pacts and prove your execution.</p>
          </div>
